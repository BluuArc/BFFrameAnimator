...
public class FileChooser {
	 ...
	 * 
	 * @param message
	 *            message to be displayed in console before opening window
	 * @return the full file name of the picked file or null
	 */
	public static String pickAFile(String message) {
		System.out.println(message);
		String fileName = pickAFile();
		return fileName;
	}
	...
	public static void setMediaPath(String directory) {
		...
		if (!file.exists()) {
			...
			/*
			 * check if there is an application properties object and if not
			 * create one
			 */
			if (appProperties == null)
				appProperties = new Properties();
