 ...
 */
public class SimplePicture2 implements DigitalPicture {
	 ...
	 */
	public SimplePicture2(String fileName) {
	 ...
	 *            the desired height
	 */
	public SimplePicture2(int width, int height) {
	 ...
	 */
	public SimplePicture2(int width, int height, Color theColor) {
		this(width, height);
	 ...
	 */
	public SimplePicture2(SimplePicture2 copyPicture) {
	 ...
	 *            the buffered image
	 */
	public SimplePicture2(BufferedImage image) {
	 ...
	 */
	public void copyPicture(SimplePicture2 sourcePicture) {
	...
	/**
	 * Method to set the alpha in the picture to the passed alpha
	 * 
	 * @param alpha
	 *            the alpha to set to
	 */
	public void setAllPixelsToAnAlpha(int alpha) {
		// loop through all x
		for (int x = 0; x < this.getWidth(); x++) {
			// loop through all y
			for (int y = 0; y < this.getHeight(); y++) {
				getPixel(x, y).setAlpha(alpha);
			}
		}
	}

	/**
	 * Method to set an image to full transparency
	 */
	 ...
	 */
	/*
	 * public void explore() { // create a copy of the current picture and
	 * explore it new PictureExplorer(new SimplePicture2(this)); }
	 */
	/**
	 * Method to force the picture to redraw itself. This is very useful after
	 * you have changed the pixels in a picture.
	 */
	public void repaint() {
	...
	public boolean load(String fileName) {
		try {
			...
			bufferedImage = new BufferedImage(600, 200, BufferedImage.TYPE_INT_ARGB);
